  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-white/70 backdrop-blur-md m-8 rounded-3xl border border-white shadow-xl">
        ...
        <p className="text-gray-700 font-medium max-w-lg">Browse our comprehensive catalog of statistical training courses. This feature is currently under development.</p>
      </main>
    </div>
  );
}
