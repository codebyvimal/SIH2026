...
def seed_data():
    ...
    profiles = [
        {
            ...
            "experience_years": 3,
            "past_trainings": [{"course_name": "Basic Python", "completed_at": datetime.utcnow().isoformat()}],
            "profile_stored": True,
    ...
    # 3. courses.json
    courses = [
        {"course_id": COURSE_ID, "title": "Advanced Python Analytics", "provider": "iGOT", "duration_hours": 10},
        {"course_id": "course-nssta-01", "title": "Applied Statistics", "provider": "NSSTA", "duration_hours": 20}
    ]
    ...
    employee_dash = {
        ...
        "recommended": [
            {"course": "Advanced Python Analytics", "course_id": COURSE_ID, "relevance": 0.95, "why": "Directly addresses your gap in Python."}
        ],
        "latest_grading": {
            "quiz_id": QUIZ_ID,
            "score": 100.0,
