...
def seed_data():
    ...
    framework = CompetencyFramework(
        skills=[
            FrameworkSkill(
                ...
                required_by_role={
                    'Data Scientist': SkillLevel.EXPERT,
                    'Analyst': SkillLevel.PROFICIENT,
                },
            ),
            FrameworkSkill(
    ...
    admin_dash = AdminDashboard(
        ...
        domain_aggregates=[
            ...
            DomainAggregate(
                domain=Domain.STATISTICAL_METHODS, avg_gap=0.5, officials_below_target=50
            ),
        ],
